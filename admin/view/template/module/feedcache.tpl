                ...
                <table id="module" class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="left"><?= $entry_timeout ?></td>
                            <td class="left"><?= $entry_url ?></td>
                    ...
                    <?php foreach($modules as $module) : ?>
                        <tbody id="module-row-<?= $module_row ?>">
                            <tr>
                                ...
                                <td class="left">
                                    <input type="text" name="<?= $module_name ?>_module[<?= $module_row ?>][timeout]" value="<?= $module["timeout"] ?>" size="1" />
                                    <span class="help"><?= $text_timeout ?></span>
                                    <?php if(isset($error_timeout[$module_row])) : ?>
                                        <span class="error"><?= $error_timeout[$module_row] ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="left">
                                    <input type="text" name="<?= $module_name ?>_module[<?= $module_row ?>][url]" value="<?= $module["url"] ?>" size="30" />
                                    <?php if(isset($error_url[$module_row])) : ?>
                                        <span class="error"><?= $error_url[$module_row] ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="left">
        ...
        $('#module > tfoot').before($('<tbody>').attr('id', 'module-row-' + module_row)
            .append($('<tr>'))
                ...
                .append($('<td>').addClass('left')
                    .append($('<input>')
                        .attr('type', 'text')
                        .attr('name', '<?= $module_name ?>_module[' + module_row + '][timeout]')
                        .attr('size', 1)
                    )
                )
                .append($('<td>').addClass('left')
                    .append($('<input>')
                        .attr('type', 'text')
                        .attr('name', '<?= $module_name ?>_module[' + module_row + '][url]')
                        .attr('size', 30)
                    )
                )
                .append($('<td>').addClass('left')
